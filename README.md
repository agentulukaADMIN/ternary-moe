...
| file | purpose |
|---|---|
| `moe_driver.py` | interactive chat: routes each question and queries the server; answers stream in live, Ctrl+C cancels the current answer without quitting, `/limit N` adjusts max answer length (default 384) |
